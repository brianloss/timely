...
import timely.store.MetaCacheImpl;
...
public class MetricsResponseTest {
    ...
    public static class TestMetricsResponse extends MetricsResponse {
        ...
        public TestMetricsResponse(TimelyConfiguration conf, MetaCache cache) {
            super(conf, cache);
        }
    ...
    public void testGenerateHtml() throws Exception {
        ...
        try {
            TimelyConfiguration cfg = TestConfiguration.createMinimalTimelyConfigurationForTest();
            MetaCache cache = new MetaCacheImpl(cfg);
            ...
            TestMetricsResponse r = new TestMetricsResponse(cfg, cache);
