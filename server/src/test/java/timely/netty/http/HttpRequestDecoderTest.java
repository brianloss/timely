...
public class HttpRequestDecoderTest {
    ...
    public static class TestHttpQueryDecoder extends HttpRequestDecoder {
        ...
        public TestHttpQueryDecoder(TimelyConfiguration config) {
            super(config);
        }
    ...
    private static TimelyConfiguration config = null;
    private static TimelyConfiguration anonConfig = null;
    ...
    public static void before() throws Exception {
        config = TestConfiguration.createMinimalTimelyConfigurationForTest();
        anonConfig = TestConfiguration.createMinimalTimelyConfigurationForTest();
